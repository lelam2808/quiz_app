...
class _CardOptionState extends State<CardOption> {
  ...
  void initState() {
    ...
    newList!.insert(
        widget.question.incorrectAnswers.length, widget.question.correctAnswer);
    newList!.sort();
    setState(() {
      isPress = false;
    });
      ...
      child: ListView(scrollDirection: Axis.vertical,
        children: [
         Column(
                children: [
                  Text(
                    "Câu hỏi thứ ${widget.indexQuestion + 1}/10",
                  ...
                  ...List.generate(
                      ...
                      (index) => GestureDetector(
                            onTap: () {
                              ...
                              print("click");
                              if (newList![index]
                                  .contains(widget.question.correctAnswer)) {
                                print("dap an dung");
                                c.score.value += 1;
                              }
                            },
